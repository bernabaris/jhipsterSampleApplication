package com.github.bernabaris.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.github.bernabaris.service.EmailAlreadyUsedException ||
            ex instanceof com.github.bernabaris.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.github.bernabaris.service.InvalidPasswordException
